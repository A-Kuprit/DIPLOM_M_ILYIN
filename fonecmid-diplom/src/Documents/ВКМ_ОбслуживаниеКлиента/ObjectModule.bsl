...
Процедура ОбработкаПроведения(Отказ, Режим)
	...
	Движения.ВКМ_ВыполненныеКлиентуРаботы.Записать(Истина);
	Движения.ВКМ_ВыполненныеСотрудникомРаботы.Записать(Истина);
	...
	|	ВКМ_ОбслуживаниеКлиента.Договор.Ссылка КАК Договор,
